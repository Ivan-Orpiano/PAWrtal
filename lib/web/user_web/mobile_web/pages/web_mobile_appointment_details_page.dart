...
class WebMobileAppointmentDetailsPage extends StatelessWidget {
  final dynamic appointment; // Replace with Appointment type
  final dynamic clinic; // Replace with Clinic type
  final dynamic pet; // Replace with Pet type

  const WebMobileAppointmentDetailsPage({
    super.key,
  ...
  void _showCancelDialog(BuildContext context, dynamic controller) {
    showDialog(
      context: context,
