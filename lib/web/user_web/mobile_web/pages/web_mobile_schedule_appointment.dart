...
class WebMobileScheduleAppointment extends StatefulWidget {
  final Clinic clinic;

  const WebMobileScheduleAppointment({super.key, required this.clinic});

  @override
  State<WebMobileScheduleAppointment> createState() => _WebMobileScheduleAppointmentState();
}

class _WebMobileScheduleAppointmentState extends State<WebMobileScheduleAppointment> {
...
// More accurate sa mobile version kasi may slight difference sa design yung sa taas
...
//                           Container(
//                             width: isSmallScreen ? 
//                               (MediaQuery.of(context).size.width - 48) / 3 - 8 : 
//                               null,
