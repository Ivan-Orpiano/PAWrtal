...
class WebDashboardTilesUpdated extends StatefulWidget {
  final List<Clinic> clinics;
  
  const WebDashboardTilesUpdated({super.key, required this.clinics});

  @override
  State<WebDashboardTilesUpdated> createState() => _WebDashboardTilesUpdatedState();
}

class _WebDashboardTilesUpdatedState extends State<WebDashboardTilesUpdated> {
  @override
