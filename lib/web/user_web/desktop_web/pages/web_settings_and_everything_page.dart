                          ...
                          onPressed: profilePictureController.isUploading.value
                              ...
                              : () async {
                                  ...
                                  if (userDocId != null && userDocId.isNotEmpty) {
                                    final newFileId = await profilePictureController.saveProfilePicture(userDocId);
                                    ...
                                    if (newFileId != null && newFileId.isNotEmpty) {
                                      ...
                                      print('>>> Stored profile picture ID in GetStorage: $newFileId');
                                      setState(() {});
                                      _showSnackbar('Success', 'Profile picture updated', Colors.green);
                                    }
                                  } else {
                                    _showSnackbar('Error', 'User document not found', Colors.red);
                                  }
                                },
