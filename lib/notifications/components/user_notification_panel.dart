...
class _UserNotificationButtonState extends State<UserNotificationButton> {
  ...
  void initState() {
    ...
    if (Get.isRegistered<UserNotificationController>()) {
      _controller = Get.find<UserNotificationController>();
    } else {
      _controller = Get.put(UserNotificationController(
        ...
        children: [
          ...
          Positioned(
            ...
            child: Material(
              ...
              color: Colors.white,
              child: UserNotificationPanel(onClose: _closePopup),
            ),
          ),
        ],
      ),
...
class UserNotificationPanel extends StatelessWidget {
  ...
  const UserNotificationPanel({super.key, required this.onClose});

  @override
  Widget build(BuildContext context) {
    final controller = Get.find<UserNotificationController>();
  ...
  Widget _buildHeader(UserNotificationController controller) {
    return Container(
  ...
  Widget _buildFilterTabs(UserNotificationController controller) {
    final filters = [
  ...
  Widget _buildNotificationsList(UserNotificationController controller) {
    return Obx(() {
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            'You\'ll see appointment updates and\nmessages from clinics here',
            textAlign: TextAlign.center,
            style: TextStyle(
              fontSize: 14,
